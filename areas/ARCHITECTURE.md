...
> **⚠️ Versiones de stack**: Esta copia local refleja el contrato v1.0.
> Versiones vigentes: Java 21 · Spring Boot 3.3 · PG 16 · Kafka 3.7 · Redis 7.2 · Angular 17.
> Decisión formal: `docs/adr/ADR-001-stack-versions.md`.
> Plan de upgrade a v2.0 (Java 25 / Boot 4.0.6 / PG 18.4 / Kafka 4.3 KRaft): `docs/adr/ADR-002-pae-001-migration-decision.md`.
...
> **Versiones según ADR-001 (vigente v1.0) — Plan de migración: PAE-001 (ADR-002, objetivo v2.0 Q4 2026)**
> La infraestructura local (`docker-compose.yml`) ya usa las versiones baseline 2026 (PG 18, Redis 8,
> Kafka KRaft). El código de aplicación permanece en las versiones v1.0 hasta la migración coordinada
> de toda la plataforma. Ver `docs/adr/ADR-002-pae-001-migration-decision.md`.

| Capa              | Tecnología                                      | Versión mínima | PAE-001 destino |
|-------------------|--------------------------------------------------|----------------|-----------------|
| Lenguaje BE       | Java                                             | 21 LTS         | 25 LTS          |
| Framework BE      | Spring Boot                                      | 3.3.x          | 4.0.6+          |
| Build BE          | Maven                                            | 3.9.x          | —               |
| Persistencia      | Spring Data JPA + Hibernate                      | 6.5.x          | —               |
| Migraciones       | Flyway                                           | 10.x           | —               |
| Base de datos     | PostgreSQL                                       | 16             | 18.4+           |
| Búsqueda full-text| PostgreSQL `tsvector` (+ OpenSearch en `products`) | OS 2.13      | —               |
| Mensajería        | Apache Kafka (Confluent / Redpanda)              | 3.7            | 4.3.x (KRaft)   |
| Cache             | Redis                                            | 7.2            | 8.x             |
