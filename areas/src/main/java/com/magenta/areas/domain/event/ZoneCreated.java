...
public final class ZoneCreated extends DomainEvent {
    ...
    public ZoneCreated(UUID zoneId, String code, String name, ZoneType type,
    ...
    @Override public String getType() { return "com.magenta.areas.ZoneCreated"; }
